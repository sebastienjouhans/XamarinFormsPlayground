...
namespace XamarinFormApp2.Commons
{
    ...
    public class JsonSerializer : IJsonSerializer
    {
        ...
        public string Serialize<T>(T data)
        {
            try
            {
                return Newtonsoft.Json.JsonConvert.SerializeObject(data, deserialiserSettings);
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex);
        ...
        public T Deserialize<T>(string data)
        {
            try
            {
                return Newtonsoft.Json.JsonConvert.DeserializeObject<T>(data, deserialiserSettings);
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex);
