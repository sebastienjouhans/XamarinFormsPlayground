...
namespace XamarinFormApp2.Extensions
{
    using System;
    ...
    internal static class Extensions
    {
        ...
        public static NetworkResponse ToNetworkResponse(this HttpResponseMessage httpResponseMessage)
        {
            return new NetworkResponse(
                ...
                httpResponseMessage.StatusCode.ToNetworkResponseStatus(),
        ...
        public static NetworkResponse<TResponse> ToStringNetworkResponse<TResponse>(
            this HttpResponseMessage httpResponseMessage,
            string responseString) where TResponse : class
        {
            return new NetworkResponse<TResponse>(
                httpResponseMessage.IsSuccessStatusCode,
                httpResponseMessage.StatusCode,
                httpResponseMessage.StatusCode.ToNetworkResponseStatus(),
                httpResponseMessage.ReasonPhrase,
                responseString as TResponse);
        }
        ...
        /// <returns>The network response with the stream return value.</returns>
        public static NetworkResponse<TResponse> ToStreamNetworkResponse<TResponse>(
            this HttpResponseMessage httpResponseMessage,
            Stream responseStream) where TResponse : class
        {
            return new NetworkResponse<TResponse>(
                httpResponseMessage.IsSuccessStatusCode,
                httpResponseMessage.StatusCode,
        ...
        public static NetworkResponse<TResponse> ToDeserializedNetworkResponse<TResponse>(
            this HttpResponseMessage httpResponseMessage,
            Stream responseStream,
            ISerializer serializer) where TResponse : class
        {
            if (serializer == null)
            {
                    ...
                    if (isSuccessful)
                    {
                        ...
                        else
                        {
                            ...
                            if (response == null)
                            {
                                Debug.WriteLine(
                                    string.Format(
                                        "Deserialization error occurred while deserializing network response from {0}",
